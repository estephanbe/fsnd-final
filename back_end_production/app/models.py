...
class Seller(db.Model):
    ...
    def __init__(
                self,
                name,
                store_description, phone_number, avatar, website, facebook_link
                ):
        self.name = name
    ...
    def __repr__(self):
        output = f'<{self.id} | '
        f'{self.name} | {self.store_description} | {self.phone_number} | '
        f'{self.avatar} | {self.website} | {self.facebook_link}>'
        return output
...
'''
tag_product_association = db.Table(
...
class Product(db.Model):
    ...
    def __repr__(self):
        output = f'<{self.id} | {self.name} | {self.description} | '
        f'{self.price} | {self.num_of_sales} | {self.total_sales} | '
        f'{self.rating} | {self.image_url} | {self.seller_id} |'
        f' {self.cat_id} | {self.creation_date} | {self.update_date}>'
        return output
...
class Review(db.Model):
    ...
    def __repr__(self):
        output = f'<{self.id} | {self.reviewer} | {self.review} | '
        f'{self.review_date} | {self.product_id}>'
        return output
